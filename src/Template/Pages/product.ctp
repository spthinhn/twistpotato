		...
		<div class="row">
			<div class="col-md-12">
				<div class="section-title">
					<div><h3>Korean BBQ chicken</h3><span></span></div>
				...
				<div class="col-sm-12">
					...
					<div class="dishes">
						<div class="dishes-content conten-product">
							<div class="dishes-icon"><i class="icon-food"></i></div>
							<h3><a href="single-dishes.html">Thành phần</a></h3>
							<p>Khoai tây : 500g</p>
							<p>Bột phô mai hàn quốc: 200g</p>
							<p>Muối, dầu ăn hoặc bơ</p>
						</div>
					</div>
					<div class="dishes">
						<div class="dishes-content conten-product">
				...
				<div class="section-title">
					<div><h3>Các loại khác</h3><span></span></div>
				</div>
			</div>
			<div class="clearfix"></div>
