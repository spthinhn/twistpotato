...
<head>
  ...
  <!--<link rel="shortcut icon" href="backend/images/favicon.png" type="image/png">-->

  <title>Quirk Responsive Admin Templates</title>

  <link rel="stylesheet" href="backend/lib/fontawesome/css/font-awesome.css">
  <link rel="stylesheet" href="backend/lib/weather-icons/css/weather-icons.css">
  <link rel="stylesheet" href="backend/lib/jquery-toggles/toggles-full.css">

  <link rel="stylesheet" href="backend/css/quirk.css">

  <script src="backend/lib/modernizr/modernizr.js"></script>
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
  <!--[if lt IE 9]>
  <script src="backend/lib/html5shiv/html5shiv.js"></script>
  <script src="backend/lib/respond/respond.src.js"></script>
  <![endif]-->
</head>
      ...
      <div class="leftpanelinner">
        ...
        <div class="media leftpanel-profile">
          <div class="media-left">
            <a href="#">
              <img src="backend/images/photos/loggeduser.png" alt="" class="media-object img-circle">
            </a>
          </div>
          ...
          <div class="tab-pane" id="contactmenu">
            ...
            <ul class="media-list media-list-contacts">
              <li class="media">
                <a href="#">
                  <div class="media-left">
                    <img class="media-object img-circle" src="backend/images/photos/user1.png" alt="">
                  </div>
                  <div class="media-body">
              ...
              <li class="media">
                <a href="#">
                  <div class="media-left">
                    <img class="media-object img-circle" src="backend/images/photos/user2.png" alt="">
                  </div>
                  <div class="media-body">
              ...
              <li class="media">
                <a href="#">
                  <div class="media-left">
                    <img class="media-object img-circle" src="backend/images/photos/user3.png" alt="">
                  </div>
                  <div class="media-body">
              ...
              <li class="media">
                <a href="#">
                  <div class="media-left">
                    <img class="media-object img-circle" src="backend/images/photos/user4.png" alt="">
                  </div>
                  <div class="media-body">
              ...
              <li class="media">
                <a href="#">
                  <div class="media-left">
                    <img class="media-object img-circle" src="backend/images/photos/user5.png" alt="">
                  </div>
                  <div class="media-body">
              ...
              <li class="media">
                <a href="#">
                  <div class="media-left">
                    <img class="media-object img-circle" src="backend/images/photos/user6.png" alt="">
                  </div>
                  <div class="media-body">
              ...
              <li class="media">
                <a href="#">
                  <div class="media-left">
                    <img class="media-object img-circle" src="backend/images/photos/user7.png" alt="">
                  </div>
                  <div class="media-body">
              ...
              <li class="media">
                <a href="#">
                  <div class="media-left">
                    <img class="media-object img-circle" src="backend/images/photos/user8.png" alt="">
                  </div>
                  <div class="media-body">
              ...
              <li class="media">
                <a href="#">
                  <div class="media-left">
                    <img class="media-object img-circle" src="backend/images/photos/user9.png" alt="">
                  </div>
                  <div class="media-body">
              ...
              <li class="media">
                <a href="#">
                  <div class="media-left">
                    <img class="media-object img-circle" src="backend/images/photos/user10.png" alt="">
                  </div>
                  <div class="media-body">
...
<script src="backend/lib/bootstrap/js/bootstrap.js"></script>
<script src="backend/lib/jquery-toggles/toggles.js"></script>

<script src="backend/js/quirk.js"></script>
